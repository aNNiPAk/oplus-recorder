...
Канал исходного stock APK `com.coloros.soundrecorder` для Obtainium.
...
Daily schedule включён. Для ручной проверки: Actions → Update OPlus recorder → Run workflow → оставить `dry_run: true`. Для публикации отключить `dry_run`.
