...
Unmodified stock APK for `com.coloros.soundrecorder`, extracted from the original OPlus firmware.

## Updates

The updater checks the official OTA source daily. To check manually, open Actions → Update OPlus recorder → Run workflow. Leave `dry_run` enabled to verify without publishing; disable it to publish a newer verified version.
